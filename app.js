...
const predefinedRisks = [
    { tipo: "FISICO", codigoEsocial: "02.01.001", perigo: "Exposicao a ruido continuo e intermitente", danos: "Diminuicao gradual da audicao, cansaco, irritacao, zumbido, fadiga, surdez" },
    { tipo: "FISICO", codigoEsocial: "02.01.002", perigo: "Vibracoes localizadas (mao-braco)", danos: "lesoes musculares, problemas nas articulacoes, fadiga muscular." },
    { tipo: "FISICO", codigoEsocial: "02.01.003", perigo: "Vibracao de corpo inteiro (aceleracao resultante de exposicao normalizada - aren)", danos: "" },
    { tipo: "FISICO", codigoEsocial: "02.01.004", perigo: "Vibracao de corpo inteiro (Valor da Dose de Vibracao Resultante - VDVR)", danos: "" },
    { tipo: "FISICO", codigoEsocial: "02.01.005", perigo: "Trabalhos com perfuratrizes e marteletes pneumaticos", danos: "" },
    { tipo: "FISICO", codigoEsocial: "02.01.006", perigo: "Radiacoes ionizantes", danos: "" },
    { tipo: "FISICO", codigoEsocial: "-", perigo: "Exposicao a radiacoes nao ionizantes", danos: "Queimaduras" },
    { tipo: "FISICO", codigoEsocial: "-", perigo: "Exposicao a frio intenso", danos: "Congelamento" },
    { tipo: "FISICO", codigoEsocial: "02.01.014", perigo: "Trabalhos com exposicao ao calor acima dos limites de tolerancia estabelecidos na NR-15, da Portaria 3.214/1978", danos: "Desidratacao" },
    { tipo: "FISICO", codigoEsocial: "02.01.015", perigo: "Pressao atmosferica anormal", danos: "lesoes musculares, problemas nas articulacoes, fadiga muscular." },
    { tipo: "FISICO", codigoEsocial: "02.01.016", perigo: "Trabalhos em caixoes ou camaras hiperbaricas", danos: "Lombalgias, lesoes musculares, problemas nas articulacoes, fadiga muscular." },
    { tipo: "FISICO", codigoEsocial: "02.01.017", perigo: "Trabalhos em tubuloes ou tuneis sob ar comprimido", danos: "" },
    { tipo: "FISICO", codigoEsocial: "02.01.018", perigo: "Operacoes de mergulho com o uso de escafandros ou outros equipamentos", danos: "" },
    { tipo: "FISICO", codigoEsocial: "-", perigo: "Exposicao a umidade, locais alagados.", danos: "Doencas respiratorias" },
    { tipo: "FISICO", codigoEsocial: "-", perigo: "Exposicao a ruido continuo e intermitente no transito", danos: "Diminuicao gradual da audicao, cansaco, irritacao, zumbido, fadiga, surdez" },
    { tipo: "QUIMICO", codigoEsocial: "-", perigo: "Inalacao de fumos metalicos", danos: "Doencas respiratorias" },
    { tipo: "QUIMICO", codigoEsocial: "-", perigo: "Inalacao de poeiras", danos: "Doencas respiratorias" },
    { tipo: "QUIMICO", codigoEsocial: "-", perigo: "Graxas, oleos", danos: "" },
    { tipo: "QUIMICO", codigoEsocial: "-", perigo: "Inalacao de fibras", danos: "Doencas respiratorias" },
    { tipo: "QUIMICO", codigoEsocial: "-", perigo: "Inalacao de nevoa", danos: "Doencas respiratorias, Queimaduras Quimicas" },
    { tipo: "QUIMICO", codigoEsocial: "-", perigo: "Lubrificantes", danos: "Dermatites de contato, irritacao de mucosas" },
    { tipo: "QUIMICO", codigoEsocial: "-", perigo: "Inalacao de gases", danos: "Queimaduras Quimicas, Doencas respiratorias" },
    { tipo: "QUIMICO", codigoEsocial: "-", perigo: "Inalacao de vapores", danos: "Doencas respiratorias, Queimaduras Quimicas" },
    { tipo: "QUIMICO", codigoEsocial: "-", perigo: "Contato da derme com substancias compostos ou produtos quimicos em geral", danos: "Dermatoses, Queimadura quimica" },
    { tipo: "QUIMICO", codigoEsocial: "01.01.001", perigo: "Arsenio e seus compostos", danos: "" },
    { tipo: "QUIMICO", codigoEsocial: "01.02.001", perigo: "Asbestos (ou amianto)", danos: "" },
    { tipo: "QUIMICO", codigoEsocial: "01.03.001", perigo: "Benzeno e seus compostos toxicos", danos: "" },
    { tipo: "QUIMICO", codigoEsocial: "01.03.002", perigo: "Estireno (vinilbenzeno)", danos: "" },
    { tipo: "QUIMICO", codigoEsocial: "01.04.001", perigo: "Berilio e seus compostos toxicos", danos: "" },
    { tipo: "QUIMICO", codigoEsocial: "01.05.001", perigo: "Bromo e seus compostos toxicos", danos: "" },
    { tipo: "QUIMICO", codigoEsocial: "01.06.001", perigo: "Cadmio e seus compostos toxicos", danos: "" },
    { tipo: "QUIMICO", codigoEsocial: "01.07.001", perigo: "Carvao mineral e seus derivados", danos: "" },
    { tipo: "QUIMICO", codigoEsocial: "01.08.001", perigo: "Chumbo e seus compostos toxicos", danos: "" },
    { tipo: "QUIMICO", codigoEsocial: "01.09.001", perigo: "Cloro e seus compostos toxicos", danos: "" },
    { tipo: "QUIMICO", codigoEsocial: "01.18.001", perigo: "Silica livre", danos: "" },
    { tipo: "BIOLOGICO", codigoEsocial: "-", perigo: "Exposicao a agentes microbiologicos (virus, fungos, bacterias, protozoarios, parasitas)", danos: "Doencas decorrentes de contaminacao" },
    { tipo: "BIOLOGICO", codigoEsocial: "03.01.001", perigo: "AGENTES BIOLOGICOS; Trabalhos em estabelecimentos de saude", danos: "" },
    { tipo: "BIOLOGICO", codigoEsocial: "03.01.002", perigo: "AGENTES BIOLOGICOS; Trabalhos com animais infectados", danos: "" },
    { tipo: "BIOLOGICO", codigoEsocial: "03.01.007", perigo: "AGENTES BIOLOGICOS; Coleta e industrializacao do lixo", danos: "" },
    { tipo: "ERGONOMICO", codigoEsocial: "-", perigo: "Esforco fisico intenso", danos: "Lombalgias, lesoes musculares, fadiga, Distensao muscular" },
    { tipo: "ERGONOMICO", codigoEsocial: "-", perigo: "Levantamento e transporte manual de peso", danos: "Dores musculares, Lombalgia" },
    { tipo: "ERGONOMICO", codigoEsocial: "-", perigo: "Postura,Torcendo toalha (Wash Rag)", danos: "Dores musculares" },
    { tipo: "ERGONOMICO", codigoEsocial: "-", perigo: "Postura, Cotovelos para fora (Elbows out)", danos: "Dores musculares" },
    { tipo: "ERGONOMICO", codigoEsocial: "-", perigo: "Postura, Ombros muito alto/muito baixo (Shoulder too high / too low)", danos: "Dores musculares" },
    { tipo: "ERGONOMICO", codigoEsocial: "-", perigo: "Trabalho em turno e noturno", danos: "Stress fisico e/ou psiquico" },
    { tipo: "ERGONOMICO", codigoEsocial: "-", perigo: "Jornada de trabalho prolongada", danos: "Stress fisico e/ou psiquico" },
    { tipo: "ERGONOMICO", codigoEsocial: "-", perigo: "Monotonia", danos: "Stress fisico e/ou psiquico" },
    { tipo: "ERGONOMICO", codigoEsocial: "-", perigo: "Postura sentado por longos periodos", danos: "Desconforto, lombalgias, lesoes, dores musculares" },
    { tipo: "ERGONOMICO", codigoEsocial: "", perigo: "Iluminacao inadequada ou deficiente", danos: "Fadiga visual" },
    { tipo: "ERGONOMICO", codigoEsocial: "-", perigo: "Movimentos repetitivos", danos: "DORT" },
    { tipo: "ERGONOMICO", codigoEsocial: "-", perigo: "Posturas incomodas ou pouco confortaveis", danos: "Lombalgias, lesoes musculares" },
    { tipo: "ERGONOMICO PSICOSSOCIAIS", codigoEsocial: "-", perigo: "Estresse", danos: "Fagida, estresse e disturbios" },
    { tipo: "ERGONOMICO PSICOSSOCIAIS", codigoEsocial: "-", perigo: "Carga de trabalho excessiva", danos: "Fagida, estresse e disturbios" },
    { tipo: "ACIDENTE", codigoEsocial: "-", perigo: "Contato com eletricidade", danos: "Choque eletrico, quimaduras, parada cardiaca, morte" },
    { tipo: "ACIDENTE", codigoEsocial: "-", perigo: "Escorregao e queda", danos: "Lesoes por quedas / torcoes" },
    { tipo: "ACIDENTE", codigoEsocial: "", perigo: "Contato com partes moveis de equipamentos", danos: "Corte, contusao, esmagamento, morte, Amputacoes" },
    { tipo: "ACIDENTE", codigoEsocial: "", perigo: "Explosao", danos: "queimadura/morte" },
    { tipo: "ACIDENTE", codigoEsocial: "-", perigo: "Queda de materiais de diferente nivel", danos: "Escoriacoes, faturas, entorse, contusoes" },
    { tipo: "ACIDENTE", codigoEsocial: "-", perigo: "Contato com arestas perfuro-cortantes", danos: "Lesoes, corte contuso, laceracoes" },
    { tipo: "ACIDENTE", codigoEsocial: "-", perigo: "Projecao de particulas, partes, pecas", danos: "Cortes, Lesao nos olhos" },
    { tipo: "ACIDENTE", codigoEsocial: "-", perigo: "Incendio", danos: "Perdas materiais, lesoes, queimaduras e morte" },
    { tipo: "ACIDENTE", codigoEsocial: "-", perigo: "Ataque de animais peconhentos ou insetos", danos: "Envenenamento / Ferimento" },
    { tipo: "ACIDENTE", codigoEsocial: "-", perigo: "Atropelamento, batidas, acidentes", danos: "Perda material, fraturas, escoriacoes, morte" },
    { tipo: "ACIDENTE", codigoEsocial: "-", perigo: "Prensagem", danos: "Lesoes / Fraturas, Morte" },
    { tipo: "ACIDENTE", codigoEsocial: "-", perigo: "Queda de diferente nivel menor ou igual a dois metros", danos: "Escoriacoes, fraturas, entorses, contusoes" },
    { tipo: "ACIDENTE", codigoEsocial: "-", perigo: "Espaco Confinado (falta de Ventilacao adequada ou deficiencia de oxigenio)", danos: "Asfixia" },
    { tipo: "ACIDENTE", codigoEsocial: "-", perigo: "Queda maior que dois metros de altura", danos: "Escoriacoes, fraturas, entorses, contusoes, morte" },
    { tipo: "ACIDENTE", codigoEsocial: "-", perigo: "Queimadura", danos: "Lesoes de pele, infeccoes" }
];
...
window.addEventListener('DOMContentLoaded', function() {
    console.log('Aplicacao carregada. Reconhecimento de voz desativado por padrao.');
});

// Restante do código app.js continua aqui...
